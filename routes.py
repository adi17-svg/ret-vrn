...
#     """
#     THE ONLY PLACE WHERE THINKING HAPPENS
#     (Single GPT Brain Version)
#     """

#     # -------------------------------------------------
#     # 1️⃣ USER SUPPORT FOCUS (unchanged)
#     # -------------------------------------------------
#     support_focus = []
#     if user_id:
#         try:
...
#     # -------------------------------------------------
#     # 🧠 3️⃣ SINGLE GPT BRAIN CALL
#     # -------------------------------------------------
#     brain = analyze_spiral_and_generate(
#         entry=entry,
#         context=context_text,
#         reply_to=reply_to,
#     )

#     stage = brain.get("stage")
#     confidence = brain.get("confidence", 0.0)
#     mood = brain.get("mood")
#     response_type = brain.get("response_type", "listen")
#     question = brain.get("mind_mirror")
#     mission = brain.get("mission")
#     ai_text = brain.get("reply")

#     # -------------------------------------------------
#     # 4️⃣ SPIRAL TRACKING (unchanged logic)
#     # -------------------------------------------------
#     direction = "unknown"
#     previous_stage = None
...
#     # -------------------------------------------------
#     # 6️⃣ FINAL RESPONSE (structure unchanged)
#     # -------------------------------------------------
#     return {
#         "message": {
#             "text": ai_text,
...
#         },
#     }
 # <-- make sure this is added at top of file
...
def process_reflection_core(
    ...
    """
    THE ONLY PLACE WHERE THINKING HAPPENS
    (Single GPT Brain Version - Optimized)
    """
    ...
    # -------------------------------------------------
    # 5️⃣ SAVE CONVERSATION (ASYNC - SPEED BOOST)
    # -------------------------------------------------
    if user_id:
        def save_async():
            try:
...
def reflect_transcription():
    ...
    try:
        ...
        current_app.logger.exception(f"Transcription error: {e}")
